...
func TestSetBSON(t *testing.T) {
	var pu PrefixUUID
	err := pu.MarshalBSON(bson.RawValue{Value: []byte{0x25, 0x0, 0x0, 0x0, 0x31, 0x36, 0x38, 0x65, 0x37, 0x31, 0x36, 0x61, 0x2d, 0x37, 0x39, 0x34, 0x61, 0x2d, 0x31, 0x31, 0x65, 0x37, 0x2d, 0x39, 0x35, 0x30, 0x62, 0x2d, 0x34, 0x63, 0x33, 0x32, 0x37, 0x35, 0x39, 0x32, 0x34, 0x32, 0x61, 0x35, 0x0}})
